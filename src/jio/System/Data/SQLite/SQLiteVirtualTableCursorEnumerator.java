...
public class SQLiteVirtualTableCursorEnumerator extends SQLiteVirtualTableCursor
    implements ISQLiteNativeHandle, IDisposable, IEnumerator {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getEndOfEnumerator() {
    try {
      java.lang.Boolean res = javonetHandle.get("EndOfEnumerator");
  ...
  public SQLiteVirtualTableCursorEnumerator(SQLiteVirtualTable table, IEnumerator enumerator) {
    ...
    try {
      javonetHandle =
          Javonet.New("System.Data.SQLite.SQLiteVirtualTableCursorEnumerator", table, enumerator);
  ...
  public void CheckClosed() {
    try {
      javonetHandle.invoke("CheckClosed");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
